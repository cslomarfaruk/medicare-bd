...
export const metadata = {
  title: 'Managemed - বাংলাদেশের প্রথম এআই-পাওয়ারড ক্লিনিক ম্যানেজমেন্ট সফটওয়্যার',
  ...
  openGraph: {
    title: 'Managemed - বাংলাদেশের চিকিৎসা ব্যবস্থায় বিপ্লব',
  ...
  twitter: {
    ...
    title: 'Managemed - এআই-পাওয়ারড স্বাস্থ্যসেবা প্ল্যাটফর্ম',
    description: 'এআই-পাওয়ারড ব্যবস্থাপনা টুলসের মাধ্যমে আপনার চিকিৎসা প্রতিষ্ঠানকে রূপান্তর করুন',
  },
  alternates: {
    canonical: 'https://Managemed.com/bn',
    languages: {
      'en': 'https://Managemed.com',
      'bn': 'https://Managemed.com/bn',
    },
  },
}
