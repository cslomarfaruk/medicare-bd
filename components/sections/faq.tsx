...
const faqs = {
  en: [
    {
      question: 'How does Managemed help my clinic?',
    ...
    },
    {
      ...
      answer: 'Yes. We migrate from Excel/other tools into Managemed—free of charge.',
      category: 'Migration',
      icon: Cloud,
    },
  ],
  bn: [
    {
      question: 'Managemed কীভাবে আমার ক্লিনিকের সাহায্য করবে?',
    ...
    },
    {
      ...
      answer: 'হ্যাঁ, এক্সেল/অন্যান্য টুল থেকে Managemed-তে ফ্রি মাইগ্রেশন।',
      category: 'মাইগ্রেশন',
      icon: Cloud,
    },
  ],
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  onClick={() => window.open('mailto:support@Managemed.app', '_blank')}
