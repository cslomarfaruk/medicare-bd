...
const headerCopy = {
  en: {
    ...
    note: 'MediCareBD follows Bangladesh medical data and security guidelines.',
  ...
  bn: {
    ...
    note: 'MediCareBD বাংলাদেশি মেডিকেল ডাটা ও সিকিউরিটি গাইডলাইন মেনে চলে।',
